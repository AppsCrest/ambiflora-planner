...
export default async function CalendarioPage({
  ...
  const [
    ...
    supabase
      .from('assignments')
      .select('id, data, periodo, team_id, worker_id, prestador_id, site_id, notas, teams(id, nome, cor), workers(id, nome), prestadores_servicos(id, nome), sites(id, nome), assignment_equipment(equipment_id), assignment_prestadores(prestador_id)')
      .gte('data', startDate)
      .lte('data', endDate),
